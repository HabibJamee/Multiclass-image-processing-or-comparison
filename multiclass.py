...
#####create path and train and test split and load

def load_data():
    """
        Load the data:
            - 7,586 images to train the network.
            - 755 images to evaluate how accurately the network learned to classify images.
    """
